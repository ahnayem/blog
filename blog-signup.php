			...
			<div class="row" style="margin-top: -50px;">
				...
				<div class="col-lg-6 posts-list">
					<div class="comment-form" style="margin-top: -25px;">
						...
						<form action="app/signup-script" method="post">
							...
							<div class="form-group form-inline">
								<div class="form-group col-md-12">
									<input type="password" class="form-control" name="pass_retype" id="pass_retype" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
								</div>
							</div>
							
							<button type="submit" style="border: 2px solid #f9cc41; hover-color:#fff" name="signup" class="btn btn-warning primary-btn">SIGN UP</button>
						</form>
					</div>
				</div>
				<div class="col-lg-3 posts-list"></div>
